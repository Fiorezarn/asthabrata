            ...
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              >
                ...
                <p className="text-justify">
                  Selamat datang di Astha Brata, mitra andal Anda dalam
                  menavigasi kompleksitas perizinan dan analisis dampak lalu
                  lintas bagi perusahaan Anda. Sebagai penyedia layanan
                  profesional yang berpengalaman, kami berkomitmen untuk
                  memberikan solusi yang tepat dan terpercaya untuk memenuhi
                  kebutuhan perizinan serta menganalisis dampak lalu lintas
                  perusahaan Anda.
                </p>
              </div>
              <nav
