  ...
  return (
    <>
      <div className="bg-white w-full  lg:h-screen py-20 px-4 lg:px-28" id="faq">
        ...
        <section className="w-full divide-y divide-slate-200 rounded border border-slate-200 bg-white mt-10">
          <details className="group p-4" open>
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
              <svg
                ...
                className="h-6 w-6  shrink-0  stroke-[#3F72AF]  "
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1.5"
            ...
            <p className="mt-4 text-slate-500">
              Andalalin adalah studi lalulintas yang wajib dilakukan bagi setiap
              investor yang akan membangun bangunan baru, pengembangan bangunan
              (sesuai dengan PM 75 tahun 2015, tentang penyelenggaraan
              andalalin) , dan juga sebagai syarat dalam penerbitan IMB (Ijin
              Mendirikan Bangunan).
            </p>
          </details>
          <details className="group p-4">
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
              ...
              Adakah peraturan yang mengatur tentang andalalin itu?
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="absolute right-0 top-1 h-4 w-4 shrink-0 stroke-slate-700 transition duration-300 group-open:rotate-45"
                fill="none"
            ...
            <p className="mt-4 text-slate-500">
              Ada, keseluruhan peraturan tersebut telah dimuat dan disyahkan
              dalam PM75 tahun 2015 tentang penyelegaraan analisis dampak
              lalulintas, serta PM 11 tahun 2017 tentang perubahan ketiga atas
              PM No75 tahun 2015.
            </p>
          </details>
          <details className="group p-4">
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
              ...
              Bagaimana proses dalam pengajuan andalalin?
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="absolute right-0 top-1 h-4 w-4 shrink-0 stroke-slate-700 transition duration-300 group-open:rotate-45"
                fill="none"
            ...
            <p className="mt-4 text-slate-500">
              <ul>
                <li>
                  Tahap 1: Pengerjaan Kajian andalalin oleh pihak ketiga
                  (konsultan)
                </li>
                <li>
                  Tahap 2: Pengajuan kajian serta surat permohonan persetujuan
                  andalalin ke instansi terkait.
                </li>
                <li>
                  Tahap 3: Ekspose atau paparan hasil kajian andalalin oleh
                  konsultan di depan tim penilai andalalin.
                </li>
                <li>
                  Tahap 4: Revisi Hasil kajian sesuai dengan masukan dari tim
                  penilai andalalin.
                </li>
                <li>
                  Tahap 5: Penerbitan rekomendasi Andalalin dari instansi
                  terkait.
                </li>
              </ul>
            </p>
          ...
          <details className="group p-4">
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
              ...
              Apakah semua bangunan baru ataupun pengembangan wajib dilakukan
            ...
            <p className="mt-4 text-slate-500">
              Terkait dengan ketentuan dan syarat minimal pembangunan atau
              pengembangan bangunan yang disyaratkan untuk dilakukan penyususnsn
              andalalin sudah diatur dalam PM. 75 tahun 2015
            </p>
          </details>
        </section>
      </div>
