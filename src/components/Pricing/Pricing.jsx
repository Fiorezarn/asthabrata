     ...
     <SwiperSlide>
      <Card className='max-w-sm my-6 lg:my-0'>
       ...
       <div className='flex items-baseline text-gray-900 dark:text-white'>
        ...
        <div className='flex items-center'>
         <span className='text-5xl font-extrabold tracking-tight mr-1'>45</span>
         <span className='text-gray-500 dark:text-gray-400 mb-6'>jt</span>
        </div>
       ...
       <ul className='my-7 space-y-5'>
        <li className='flex space-x-3'>
         <svg
          className='h-5 w-5 shrink-0 text-[#3F72AF] dark:text-cyan-500'
          fill='currentColor'
          viewBox='0 0 20 20'
     ...
     <SwiperSlide>
      <Card className='max-w-sm my-6 lg:my-0 '>
       ...
       <div className='flex items-baseline text-gray-900 dark:text-white'>
        <span className='text-3xl font-semibold'>Rp</span>
        <div className='flex items-center'>
         <span className='text-5xl font-extrabold tracking-tight mr-1'>55</span>
         <span className='text-gray-500 dark:text-gray-400 mb-6'>jt</span>
        </div>
        <span className='ml-1 text-xl font-normal text-gray-500 dark:text-gray-400'>
         /Project
     ...
     <SwiperSlide>
      <Card className='max-w-sm my-6 lg:my-0'>
       ...
       <div className='flex items-baseline text-gray-900 dark:text-white'>
        <span className='text-3xl font-semibold'>Rp</span>
        <div className='flex items-center'>
         <span className='text-5xl font-extrabold tracking-tight mr-1'>75</span>
         <span className='text-gray-500 dark:text-gray-400 mb-6'>jt</span>
        </div>
        <span className='ml-1 text-xl font-normal text-gray-500 dark:text-gray-400'>
         /Project
     ...
     <SwiperSlide>
      <Card className='max-w-sm my-6 lg:my-0'>
       ...
       <div className='flex items-baseline text-gray-900 dark:text-white'>
        <span className='text-3xl font-semibold'>Rp</span>
        <div className='flex items-center'>
         <span className='text-5xl font-extrabold tracking-tight mr-1'>80</span>
         <span className='text-gray-500 dark:text-gray-400 mb-6'>jt</span>
        </div>
        <span className='ml-1 text-xl font-normal text-gray-500 dark:text-gray-400'>
         /Project
